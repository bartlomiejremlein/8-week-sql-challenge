...
2. Create a table for loyalty program, where member customers purchases are ranked, and purchases for non-members are returned as null.
...
Click [**here**](Answers/README.md) to see the answers.